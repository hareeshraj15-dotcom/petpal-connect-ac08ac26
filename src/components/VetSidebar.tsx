...
import { 
  Home, Calendar, Stethoscope, FileText, Pill, MessageCircle, 
  User, Clock, LogOut, Heart, Menu, X, FileCheck, Star
} from 'lucide-react';
...
const menuItems = [
  ...
  { to: '/vet-dashboard/documents', icon: FileCheck, label: 'Documents' },
  { to: '/vet-dashboard/feedback', icon: Star, label: 'Feedback' },
